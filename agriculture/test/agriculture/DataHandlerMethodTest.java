 ...
 */
public class DataHandlerMethodTest {
    
    public DataHandlerMethodTest() {
    }
    ...
    /**
     * Test of handleRawData method, of class DataHandlerMethod.
     */
    @Test
    public void testHandleRawData() {
        System.out.println("handleRawData");
        Reading rawReading = null;
        DataHandlerMethod instance = new DataHandlerMethod();
